...
def resnet9(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet9", BasicBlock, [1, 2, 2, 1], pretrained, progress, **kwargs)

def resnext1(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    r"""ResNeXt-50 32x4d model from
    `"Aggregated Residual Transformation for Deep Neural Networks" <https://arxiv.org/pdf/1611.05431.pdf>`_.
    ...
    kwargs["groups"] = 32
    kwargs["width_per_group"] = 4
    return _resnet("resnext50_32x4d", Bottleneck, [1, 1, 1, 1], pretrained, progress, **kwargs)
...
from utils.misc import ConvNormActivation, SqueezeExcitation as SElayer
from utils.utils import _log_api_usage_once
